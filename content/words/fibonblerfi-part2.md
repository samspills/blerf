...
I got momentarily distracted by the power of `Display` and implemented one for `FibonacciNumber` that gave each number the proper ordinal indicator. This was very satisfying. (Update: I have just realized I have an 11 bug. Damn.)
