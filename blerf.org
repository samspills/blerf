...
* Scala :scala:
** DRAFT Refs and Streams 1: Scheduling Updates :cats_effect:fs2:rough_thoughts:
:PROPERTIES:
...
[fn:3] This code sample is also available as [[https://gist.github.com/samspills/b1a3434e1bac21ac9c62004df2f25306][a gist]]. You can run it directly using ~scala-cli~.
